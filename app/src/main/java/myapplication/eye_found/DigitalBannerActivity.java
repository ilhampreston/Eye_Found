...
public class DigitalBannerActivity extends AppCompatActivity {
    public static final String url_data_digitalbanner = "http://eyefoundapp.esy.es/eyefound/datadigitalbanner.php";
    ...
    private RecyclerViewAdapterDigitalBanner RVAdapterDigitalBanner;
    List<ListDigitalBanner> digitalBannerList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_digital_banner);

        recyclerView = findViewById(R.id.listDigitalBanner);
    ...
    private void getDigitalBanner() {
        StringRequest stringRequest = new StringRequest(url_data_digitalbanner, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.e("Response :", response.toString());

                digitalBannerList = new ArrayList<ListDigitalBanner>();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        digitalBannerList.add(new ListDigitalBanner(id_mediakit, sidecode, loc, cityname, view, mediatype, type_light, filepdf, photos, orientation, sizewidth, sizeheight));
                    }

                    RVAdapterDigitalBanner = new RecyclerViewAdapterDigitalBanner(digitalBannerList);
                    recyclerView.setAdapter(RVAdapterDigitalBanner);
                }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DigitalBannerActivity.this,error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
