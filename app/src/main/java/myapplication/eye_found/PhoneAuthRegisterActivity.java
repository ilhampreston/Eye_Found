...
public class PhoneAuthRegisterActivity extends AppCompatActivity {

    private TextView phonenumber, timertext, resendcode;
    private String url_regist = "http://eyefoundapp.esy.es/eyefound/register.php";
        ...
        timertext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!phonenumber.getText().toString().trim().isEmpty() && phonenumber.getText().toString().trim().length() >= 13) {
                    ...
                    btnVerify.setTag("verify");
                    Snackbar snackbar = Snackbar
                            .make(findViewById(R.id.layoutConstraint), "Resending verification code...", Snackbar.LENGTH_LONG);
                    snackbar.show();
                }
            }
        });
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            if (e instanceof FirebaseAuthInvalidCredentialsException){
                Toast.makeText(PhoneAuthRegisterActivity.this,"Verification Failed !! Invalid verification Code", Toast.LENGTH_LONG).show();
            }
            else if (e instanceof FirebaseTooManyRequestsException){
                Toast.makeText(PhoneAuthRegisterActivity.this,"Verification Failed !! Too many request. Try after some time. ", Toast.LENGTH_LONG).show();
            }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential phoneAuthCredential) {
        mAuth.signInWithCredential(phoneAuthCredential).
                addOnCompleteListener(PhoneAuthRegisterActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url_regist, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (success.equals("1")) {
                                    Toast.makeText(PhoneAuthRegisterActivity.this, "Register Success", Toast.LENGTH_SHORT).show();
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                                Toast.makeText(PhoneAuthRegisterActivity.this, "Register Error", Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    Intent intent = new Intent(PhoneAuthRegisterActivity.this, LoginActivity.class);
